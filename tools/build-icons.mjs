...
const ICONS = ['menu', 'close', 'add', 'arrow--left', 'arrow--right', 'renew', 'keyboard', 'terminal', 'maximize', 'minimize', 'link', 'chevron--right', 'search', 'checkmark', 'trash-can', 'help', 'game--console', 'temperature--hot', 'settings', 'battery--full', 'mobile', 'chip', 'dashboard'];
