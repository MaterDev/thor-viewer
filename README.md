...
- **Stats bar.** A thin, translucent strip centered along the top reports the live stream: frames per second, resolution, and bandwidth (e.g. `56 fps · 832×396 · 6.1 Mb/s`). It measures what you are actually seeing *through* the viewer, independent of whatever the page inside is doing. Hide it from the Controls panel.
